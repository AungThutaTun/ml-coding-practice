...
plt.savefig('Seaborn_Figure01.png')
...
sns.regplot(x='total_bill', y='tip', data=tips,color='blue',scatter_kws={'s':50, 'alpha':0.5}, line_kws={'linestyle': '--'}, fit_reg=False ,ax=ax2)