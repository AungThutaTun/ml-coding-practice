...
#추가 코드  - 이 쎌은 그림 6-8을 생성하고 저장합니다
import matplotlib.pyplot as plt
from matplotlib.colors import ListedColormap

custom_cmap = ListedColormap(["#fafafa", "#9898ff", "#a0faa0"])
...
X_grid = np.c_[z0s.ravel(), z1s.ravel()]
y_pred = tree_clf_pca.predict(X_grid).reshape(z0s.shape)
